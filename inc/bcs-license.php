...
function bcs_check_license($licensekey, $localkey='') {
    ...
    $whmcsurl = 'https://servicedesk.bcs.solutions/';
    // Must match what is specified in the MD5 Hash Verification field
    // of the licensing product that will be used with this check.
    $licensing_secret_key = 'ceezei3Si3om';
...
if(isset($options['bcs_book_import_local_key'])){
    $localkey = __($options['bcs_book_import_local_key']);
}
